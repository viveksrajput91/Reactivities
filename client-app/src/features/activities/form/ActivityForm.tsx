...
export default function ActivityForm({formClose,selectedActivity,addOrEditActivity}:Props){
    ...
    return (
        <Segment clearing>
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Input placeholder="Date" name='date' value={activity.date} onChange={onchangeInput}></Form.Input>
                ...
                <Button positive floated="right" type="submit" content="Submit"></Button>
